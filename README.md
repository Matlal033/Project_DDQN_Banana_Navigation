...
To train the agent from scratch, first make sure that the path to the UnityEnvironment is correctlyly mapped to the *Banana.exe* file in the *main.py* file,
...
To watch a trained agent, first make sure that the path to the UnityEnvironment is correctly mapped to the *Banana.exe* file in the *main.py* file.\
